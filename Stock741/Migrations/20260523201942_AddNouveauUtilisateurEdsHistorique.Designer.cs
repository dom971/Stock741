...
namespace Stock741.Migrations
{
    ...
    [Migration("20260523201942_AddNouveauUtilisateurEdsHistorique")]
    partial class AddNouveauUtilisateurEdsHistorique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Stock741.Models.HistoriqueMouvement", b =>
                {
                    ...
                    b.Property<int?>("NouveauUtilisateurId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NouveauEdsId");

                    b.HasIndex("NouveauLieuId");

                    b.HasIndex("NouveauStatutId");

                    b.HasIndex("NouveauUtilisateurId");
            ...
            modelBuilder.Entity("Stock741.Models.HistoriqueMouvement", b =>
                {
                    ...
                    b.HasOne("Stock741.Models.Eds", "NouveauEds")
                        .WithMany()
                        .HasForeignKey("NouveauEdsId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Stock741.Models.Utilisateur", "NouveauUtilisateur")
                        .WithMany()
                        .HasForeignKey("NouveauUtilisateurId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("NouveauEds");

                    b.Navigation("NouveauLieu");

                    b.Navigation("NouveauStatut");

                    b.Navigation("NouveauUtilisateur");
