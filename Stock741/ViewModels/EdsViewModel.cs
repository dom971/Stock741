...
namespace Stock741.ViewModels
{
    public class EdsViewModel : BaseViewModel
    {
        ...
        {
            get => _pageActuelle;
            set { _pageActuelle = value; OnPropertyChanged(); OnPropertyChanged(nameof(InfoPage)); }
        }
        ...
        {
            get => _totalPages;
            set { _totalPages = value; OnPropertyChanged(); OnPropertyChanged(nameof(InfoPage)); }
        }

        public string InfoPage => $"Page {PageActuelle} / {TotalPages}";
        ...
        public ICommand PageSuivanteCommand { get; }
        public ICommand PagePrecedenteCommand { get; }
        ...
        public EdsViewModel(EdsRepository repository)
        {
            ...
            InitialiserEdsCommand = new RelayCommand(_ => { EffacerChamps(); EffacerErreur(); });
            ...
            PageSuivanteCommand = new AsyncRelayCommand(async _ =>
            {
            ...
            PagePrecedenteCommand = new AsyncRelayCommand(async _ =>
            {
                if (PageActuelle > 1)
                {
                    PageActuelle--;
